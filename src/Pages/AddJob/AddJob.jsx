...
const AddJob = () => {
    ...
    return (
        <div>
            <h2 className='font-serif font-extrabold text-center pt-2'>Please add a job</h2>
            <form onSubmit={handleAddAJob}>
                ...
                <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-full border p-4">
                    ...
                    <textarea className="textarea" name='description' placeholder="write description"></textarea>
